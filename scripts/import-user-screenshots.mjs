...
const assetsDir =
	'C:/Users/Aman/.cursor/projects/c-Users-Aman-valoranthacks/assets';
...
const USER_SCREENSHOTS = [
	...
	},
	{
		...
		file: 'valorant-wallhack-skeleton.webp',
	},
	{
		source:
		...
		file: 'valorant-aimbot-sniper.webp',
	},
	{
		source:
		...
		file: 'valorant-aimbot-skeleton.webp',
	},
	{
		source:
...
async function generateResponsiveVariants() {
	const heroSource = path.join(imagesDir, 'valorant-esp-player-tags.webp');
	...
	for (const { file } of USER_SCREENSHOTS) {
		if (file === 'valorant-esp-player-tags.webp') continue;
...
async function generateFavicons() {
	const logoPath = path.join(imagesDir, 'valorant-hacks-logo.png');
