	...
	const categories = [
		{
			...
			links: [
				...
				{ href: '/valorant-esp/', labelKey: 'homeSeo.linkEsp' },
				{ href: '/valorant-aimbot/', labelKey: 'homeSeo.linkAimbot' },
				{ href: '/valorant-radar-hack/', labelKey: 'homeSeo.linkRadar' },
			],
		},
		{
			...
			links: [
				...
				{ href: '/valorant-hacks/', labelKey: 'homeSeo.linkUndetected' },
		...
		},
		{
			...
			links: [
				...
				{ href: '/valorant-hacks/', labelKey: 'homeSeo.linkValorantCheats' },
				{ href: '/features/', labelKey: 'homeSeo.linkAllFeatures' },
			],
		},
		{
