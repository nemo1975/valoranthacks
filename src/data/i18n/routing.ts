...
export const localizedSlugs: Record<PageId, Record<LocaleCode, string>> = {
	...
	features: {
		...
		de: 'valorant-hacks-funktionen',
		pt: 'recursos-cheats-valorant',
		it: 'funzioni-trucchi-valorant',
		nl: 'valorant-hacks-functies',
		pl: 'funkcje-cheatow-valorant',
		ru: 'funkcii-chitov-valorant',
		tr: 'valorant-hile-ozellikleri',
		ar: 'valorant-hacks-features',
		ja: 'valorant-hacks-features',
		ko: 'valorant-hacks-features',
		zh: 'valorant-hacks-features',
		hi: 'valorant-hacks-features',
		id: 'valorant-hacks-features',
		th: 'valorant-hacks-features',
		vi: 'valorant-hacks-features',
		uk: 'funkcii-chitiv-valorant',
		cs: 'valorant-hacks-funkce',
		ro: 'functii-cheats-valorant',
		sv: 'valorant-hacks-funktioner',
	},
	pricing: {
		en: 'pricing',
		es: 'precios-trucos-valorant',
		fr: 'prix-triche-valorant',
		de: 'valorant-hacks-preise',
		pt: 'precos-cheats-valorant',
		it: 'prezzi-trucchi-valorant',
		nl: 'valorant-hacks-prijzen',
		pl: 'ceny-cheatow-valorant',
		ru: 'ceny-chitov-valorant',
		tr: 'valorant-hile-fiyatlari',
		ar: 'valorant-hacks-pricing',
		ja: 'valorant-hacks-pricing',
		ko: 'valorant-hacks-pricing',
		zh: 'valorant-hacks-pricing',
		hi: 'valorant-hacks-pricing',
		id: 'valorant-hacks-pricing',
		th: 'valorant-hacks-pricing',
		vi: 'valorant-hacks-pricing',
		uk: 'ciny-chitiv-valorant',
		cs: 'valorant-hacks-ceny',
		ro: 'preturi-cheats-valorant',
		sv: 'valorant-hacks-priser',
	},
	setup: {
		en: 'setup',
		es: 'instalacion-trucos-valorant',
		fr: 'installation-triche-valorant',
		de: 'valorant-hacks-installation',
		pt: 'instalacao-cheats-valorant',
		it: 'installazione-trucchi-valorant',
		nl: 'valorant-hacks-installatie',
		pl: 'instalacja-cheatow-valorant',
		ru: 'ustanovka-chitov-valorant',
		tr: 'valorant-hile-kurulum',
		ar: 'valorant-hacks-setup',
		ja: 'valorant-hacks-setup',
		ko: 'valorant-hacks-setup',
		zh: 'valorant-hacks-setup',
		hi: 'valorant-hacks-setup',
		id: 'valorant-hacks-setup',
		th: 'valorant-hacks-setup',
		vi: 'valorant-hacks-setup',
		uk: 'vstanovka-chitiv-valorant',
		cs: 'valorant-hacks-instalace',
		ro: 'instalare-cheats-valorant',
		sv: 'valorant-hacks-installation',
	},
	updates: {
		en: 'updates',
		es: 'actualizaciones-trucos-valorant',
		fr: 'mises-a-jour-triche-valorant',
		de: 'valorant-hacks-updates',
		pt: 'atualizacoes-cheats-valorant',
		it: 'aggiornamenti-trucchi-valorant',
		nl: 'valorant-hacks-updates',
		pl: 'aktualizacje-cheatow-valorant',
		ru: 'obnovleniya-chitov-valorant',
		tr: 'valorant-hile-guncellemeleri',
		ar: 'valorant-hacks-updates',
		ja: 'valorant-hacks-updates',
		ko: 'valorant-hacks-updates',
		zh: 'valorant-hacks-updates',
		hi: 'valorant-hacks-updates',
		id: 'valorant-hacks-updates',
		th: 'valorant-hacks-updates',
		vi: 'valorant-hacks-updates',
		uk: 'onovlennya-chitiv-valorant',
		cs: 'valorant-hacks-aktualizace',
		ro: 'actualizari-cheats-valorant',
		sv: 'valorant-hacks-uppdateringar',
	},
	faq: {
		en: 'faq',
		es: 'preguntas-trucos-valorant',
		fr: 'faq-triche-valorant',
		de: 'valorant-hacks-faq',
		pt: 'faq-cheats-valorant',
		it: 'faq-trucchi-valorant',
		nl: 'valorant-hacks-faq',
		pl: 'faq-cheatow-valorant',
		ru: 'faq-chitov-valorant',
		tr: 'valorant-hile-sss',
		ar: 'valorant-hacks-faq',
		ja: 'valorant-hacks-faq',
		ko: 'valorant-hacks-faq',
		zh: 'valorant-hacks-faq',
		hi: 'valorant-hacks-faq',
		id: 'valorant-hacks-faq',
		th: 'valorant-hacks-faq',
		vi: 'valorant-hacks-faq',
		uk: 'faq-chitiv-valorant',
		cs: 'valorant-hacks-faq',
		ro: 'faq-cheats-valorant',
		sv: 'valorant-hacks-faq',
	},
	support: {
		en: 'support',
		es: 'soporte-trucos-valorant',
		fr: 'support-triche-valorant',
		de: 'valorant-hacks-support',
		pt: 'suporte-cheats-valorant',
		it: 'supporto-trucchi-valorant',
		nl: 'valorant-hacks-support',
		pl: 'wsparcie-cheatow-valorant',
		ru: 'podderzhka-chitov-valorant',
		tr: 'valorant-hile-destek',
		ar: 'valorant-hacks-support',
		ja: 'valorant-hacks-support',
		ko: 'valorant-hacks-support',
		zh: 'valorant-hacks-support',
		hi: 'valorant-hacks-support',
		id: 'valorant-hacks-support',
		th: 'valorant-hacks-support',
		vi: 'valorant-hacks-support',
		uk: 'pidtrymka-chitiv-valorant',
		cs: 'valorant-hacks-podpora',
		ro: 'suport-cheats-valorant',
		sv: 'valorant-hacks-support',
	},
	undetected: {
		en: 'undetected-valorant-hacks',
		es: 'trucos-valorant-indetectables',
		fr: 'triche-valorant-indetectable',
		de: 'unentdeckte-valorant-hacks',
	...
	'best-cheats': {
		...
		cs: 'nejlepsi-valorant-hacks',
		ro: 'cele-mai-bune-cheats-valorant',
		sv: 'basta-valorant-hacks',
	},
	'aimbot-hack': {
