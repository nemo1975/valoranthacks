import { HREFLANG_ALTERNATE_COUNT, type PageId } from './i18n/routing';
...
export const pageSitemapMeta: Record<PageId, PageSitemapMeta> = {
	home: { priority: 0.95, changefreq: 'daily', i18nPriority: 0.88, lastmod: '2026-08-28' },
	/** Money URL for "valorant hacks" */
	hacks: { priority: 1.0, changefreq: 'weekly', i18nPriority: 0.9, lastmod: '2026-08-28' },
	...
	radar: { priority: 0.9, changefreq: 'weekly', i18nPriority: 0.85, lastmod: '2026-08-28' },
	'vanguard': { priority: 0.3, changefreq: 'yearly', i18nPriority: 0.2, lastmod: '2026-08-13' },
	'valorant-esp': { priority: 0.92, changefreq: 'weekly', i18nPriority: 0.86, lastmod: '2026-08-28' },
	'valorant-aimbot': { priority: 0.92, changefreq: 'weekly', i18nPriority: 0.86, lastmod: '2026-08-28' },
	pricing: { priority: 0.94, changefreq: 'weekly', i18nPriority: 0.85, lastmod: '2026-08-28' },
	features: { priority: 0.9, changefreq: 'weekly', i18nPriority: 0.84, lastmod: '2026-08-28' },
	setup: { priority: 0.88, changefreq: 'weekly', i18nPriority: 0.84, lastmod: '2026-08-28' },
	updates: { priority: 0.93, changefreq: 'daily', i18nPriority: 0.85, lastmod: '2026-08-28' },
	faq: { priority: 0.8, changefreq: 'monthly', i18nPriority: 0.82, lastmod: '2026-08-28' },
	support: { priority: 0.8, changefreq: 'monthly', i18nPriority: 0.82, lastmod: '2026-08-28' },
	privacy: { priority: 0.4, changefreq: 'yearly', i18nPriority: 0.35, lastmod: '2026-08-28' },
	refund: { priority: 0.4, changefreq: 'yearly', i18nPriority: 0.35, lastmod: '2026-08-28' },
	terms: { priority: 0.4, changefreq: 'yearly', i18nPriority: 0.35, lastmod: '2026-08-28' },
};
...
export const SITEMAP_COUNTS = {
	...
	hreflangLinksPerUrl: HREFLANG_ALTERNATE_COUNT,
